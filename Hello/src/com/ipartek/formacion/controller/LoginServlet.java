...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(final HttpServletRequest request,
		...
		if (validarUsuarios(user, password)) {
			...
			dispatcher = request
					.getRequestDispatcher(Constantes.PAGINA_INICIAL);
			...
			request.setAttribute(Constantes.ATT_MENSAJE,
	...
	private boolean validarUsuarios(final String user, final String password) {
		...
		// user.equals("urko");
		if (user != null && password != null && user.equals("urko")
				&& password.equals("urko")) {
			valido = true;
		}
