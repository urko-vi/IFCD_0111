...
public class Curso {
	...
	public void setPrecio(double precio) throws CursoException {
		if(precio>=PRECIO_CURSO){
			this.precio = precio;
		}else{
			throw new CursoException(CursoException.MSG_ERROR_PRECIO,
					CursoException.COD_ERROR_PRECIO);
		}
	}
	...
	public void setCodigo(int codigo) throws CursoException {
		if(codigo > CODIGO_CURSO){
			...
			throw new CursoException(CursoException.MSG_ERROR_CODIGO, 
					CursoException.COD_ERROR_CURSO);
		}
	}
